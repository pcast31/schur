...
\([\![1, p]\!]\) is the function \(f\) that \(\forall x \in [\![1, p]\!], x \in A_{f(x)}\). Likewise, the partition associated to 
a colouring \(f\) of \([\![1, p]\!]\) with \(n\) colors is \(\forall i \in [\![1, n]\!], A_i = f^{-1}(i)\).
\end{definition}
