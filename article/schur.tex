...
The following proposition may improve the additive constant of a S-template.
...
\begin{proof}[\textsc{Proof.}]
The idea is the same as in the previous theorem. The only difference is the S-template property inherited 
...
\par
The first three inequalities are optimal. The fourth one is optimal among symmetric S-templates whose special color is 
...
Finally, the sixth one is obtained by combining a S-template with width 380 and one with width 3. 
Although we could not find a better S-template with seven colors, the last inequality is definitely very far from the 
