...
we will keep this name in the entire article. We find suitable templates and use them to provide new lower bounds for Schur numbers.
...
\qquad The main result on SF-templates follows. It allows us to improve lower bounds on Schur numbers by finding 
suitable SF-templates.
