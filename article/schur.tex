...
This shows the inequality \(S(2+2) \geqslant S^+(3)S(2)\), with the extra constant. 
We prooved \(S^+(3) = 9\).The special color is blue. 

\(\overset{SF\textrm{-template}}{\textrm{Sum-free partition} \left \updownarrow\overleftrightarrow{\begin{tabular}{|*{9}{c|}}
	\hline
...
\begin{center}
\(SF\)-template with 3 colors (it is actually maximal)\\
\begin{tabular}{|*{9}{c|}}
	\hline 
	\cellcolor{red} 1 & \cellcolor{green} 2 & \cellcolor{green} 3 & \cellcolor{red} 4 & \cellcolor{blue} 5 & \cellcolor{blue} 6 & \cellcolor{red} 7 & \cellcolor{blue} 8 & \cellcolor{blue} 9\\
	\hline
...
Sum-free partition (\(S(2)\) actually) \\
\begin{tabular}{|*{4}{c|}}
	\hline 
...
\( \forall x \in [\![1,pq + m_{k+1}-1]\!] \), we write \(x = \alpha p - u\) where \(\alpha \in [\![1,q]\!] \) and \( u \in
[\![0,p-1]\!] \).
