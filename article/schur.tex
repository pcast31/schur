...
\label{thm:Stemp}
	...
	and a sum-free \(k\)-partition of \([\![1,p]\!]\) then there exists a partition of \([\![1,pq+m_{n+1}
...
A S-template with \(n\) colors is said to be symmetric if the sum-free \(n\)-partition derived 
