...
\((a, b)\) (for the lexicographic order). When the number of colors excceeded 5, we looked for symmetric SF-templates, 
we assumed that the special color was the last color to appear and we constrained the \(m_c\)'s out of being too small.
