...
\begin{notation}
Let \(P\) be a predicate over weakly sum-free partitions. We denote by \(WS(n | P)\) the greatest number \(N\) such that there exists a partition of  
\([\![1,N]\!]\) in n weakly sum-free subsets which verifies P.
\end{notation}
