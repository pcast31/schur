...
\qquad [OLD VERSION] These new results come from an extension of Rowley's template-based approach for Ramsey graphs and 
...
\qquad [NEW VERSION] The new results we provide come from an extension of a template-based approach for Ramsey graphs
