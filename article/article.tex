...
to get explicit partitions improving lower bounds. We also developed a new method to improve weak Schur lower bounds. Furthermore, this paper tries to analyse former work on the subject based on
the principle that good partitions into \(n+1\) subsets start with good partitions into \(n\) subsets. We show that exceeding
the previous lower bound \(WS(6) \geqslant 582\) is impossible with such an assumption upon imposing certain conditions on the good
...
if lower bounds are later improved using better templates. Moreover, studying specifically \(S^+(n)\) and \(WS^+(n)\) numbers might be
...
us during the whole research and writing. Finally, last but not least, we would like to address warm thanks 
