...
\(\WS^+(n)\), which may have an interest as they are closely related to the problem at hand. 
...
becomes better understood and larger templates are found. For example, one may try to use
...
bound \(\WS(5) \geqslant 196\) \cite{ELIAHOU2012175} it was obtained by considering the same type of search space.


\section{Acknowledgments}

\qquad We would first like to thank our school \textit{CentraleSupélec} and its pole "Formation \`a la recherche" which allowed us to work
