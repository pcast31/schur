...
calculative properties on \(\pi\) reflecting the behaviour of an element's column number in Table 3.1 and that we will use later
when we introduce WSF-templates.
\end{sloppypar}
...
After defining the function related to the column number of each element in Table 3.1,
...
\((a, b)\) (in the lexicographic order).
