...
arbitrarly so that all of the Schur number five partitions could tested in a few hours.

However, trying out all of the 2\,447\,113\,088 Schur number five partitions (\cite{Heule2017}) one by one would not result in a 
