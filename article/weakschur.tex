...
Let  \(x\in [\![1,b]\!]\), let  \(y\in \mathbb{N}^*\) such that \(x+\pi(y)\leqslant a+b\)
...
\end{proposition}
\begin{proof}[\textsc{Proof.}]
Let \((a,b)\in (\mathbb{N}^*)^2\), \(a>b\), let  \(x\in \mathbb{N}^*\),\\
...
\begin{remark}
Acutally, like for SF-templates, the additive constant of a WSF-template can be improved by weakening the hypotheses made on 
