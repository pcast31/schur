...
as \(\tilde{\pi}(x)\) in the weakly sum-free coloring of \([\![1,q]\!]\). As long as \(2q \leqslant a + r\) (not going two far to the right) and there
...
first row different from the coloring of the other rows would weaken the constraints. Actually, one may even go further by
