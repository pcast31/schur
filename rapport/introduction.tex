...
Our study focuses on the lower bounds for these numbers.
...
Our templates provide new lower bounds (and inequalities) for weak Schur numbers. This construction also includes as a special 
...
\par
Finally, in the \hyperref[SearchSpace]{section 4}, we analyze the significant difference between new lower 
bounds obtained with templates and the former lower bounds obtained by computer search and we provide 
evidence which indicates that the main assumption made in those articles removes the optimal partitions from the 
search space.
